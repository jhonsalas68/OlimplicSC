        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                <div class="md:col-span-2 flex items-center space-x-6 mb-4">
                    <div class="shrink-0">
                        <img class="h-20 w-20 object-cover rounded-full border-2 border-slate-100 shadow-sm" src="{{ $user->avatar_url }}" alt="Avatar actual">
                    </div>
                    <label class="block">
                        ...
                        "/>
                        <p class="mt-1 text-xs text-slate-500">Recomendado: 200x200px. Máx 2MB.</p>
                    </label>
                </div>
