<header id="main-navbar" class="h-16 flex items-center justify-between px-4 sm:px-6 flex-shrink-0 glass-header border-b-0 transition-all duration-300 z-40" style="background-color: rgba(198, 28, 44, 0.95); backdrop-filter: blur(8px);">
