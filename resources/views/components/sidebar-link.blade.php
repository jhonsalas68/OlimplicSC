...
<a href="{{ $href }}" data-turbo-prefetch="true"
   ...
   class="flex items-start px-4 py-3 text-sm font-bold rounded-xl transition-all duration-300 group/link
          {{ $active 
    ...
    <svg class="flex-shrink-0 h-5 w-5 mt-0.5 transition-transform duration-300 group-hover/link:scale-110 
